...
namespace Phoenix3D_Components.Model.Deconstruct
{
    public class DeconstructCrossSection_Component : GH_Component
    {
        ...
        public DeconstructCrossSection_Component(): base("Deconstruct CrossSection", "DecCrSec","deconstructs a CrossSection into its parts Name, Area, Iy, Iz, It, Wy, Wz, Wt ", "Phoenix3D", "   Geometry")
        {
        }
        ...
        {
            pManager.AddTextParameter("Name", "NA", "Name of CrossSection", GH_ParamAccess.list);
            pManager.AddNumberParameter("Area", "AR", "Area of CrossSection", GH_ParamAccess.list);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.GetDataList(0, crossSections);
        ...
        protected override System.Drawing.Bitmap Icon => Properties.Resources.deconstruct_cs;

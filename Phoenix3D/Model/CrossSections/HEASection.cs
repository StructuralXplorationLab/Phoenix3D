...
namespace Phoenix3D.Model.CrossSections
{
    public class HEASection : ICrossSection
    {
        ...
        {
            bool found = false;
            string[] csvstring = Properties.Resources.HEASections.Split(new char[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries);
            ...
            if (!found)
            {
                throw new System.Exception("No HEA-Section with the given dimension could be found in the standard table");
            }
        }

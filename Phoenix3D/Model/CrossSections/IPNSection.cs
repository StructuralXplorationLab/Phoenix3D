...
{
    public class IPNSection : ICrossSection
    {
        public string TypeName { get; private set; } = "IPN";
        ...
        public IPNSection(int Size = 100)
        {
            this.Name = "IPN " + Size.ToString();
        ...
        {
            bool found = false;
            string[] csvstring = Properties.Resources.IPNSections.Split(new char[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries);
            ...
            if (!found)
            {
                throw new System.Exception("No IPE-Section with the given dimension could be found in the standard table");
            }
        }
        public void SetPolygon()
        {
            ...
            Polygon.Add((Width - cy, FlangeThickness - cz));
            Polygon.Add((Width / 2 + WebThickness / 2 - cy, FlangeThickness - cz));
            Polygon.Add((Width / 2 + WebThickness / 2 - cy, Height - FlangeThickness - cz));
            Polygon.Add((Width - cy, Height - FlangeThickness - cz));
            Polygon.Add((Width - cy, Height - cz));
            Polygon.Add((0 - cy, Height - cz));
            Polygon.Add((0 - cy, Height - FlangeThickness - cz));
            Polygon.Add((Width / 2 - WebThickness / 2 - cy, Height - FlangeThickness - cz));
            Polygon.Add((Width / 2 - WebThickness / 2 - cy, FlangeThickness - cz));
            Polygon.Add((0 - cy, FlangeThickness - cz));
